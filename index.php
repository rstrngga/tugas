...
<body>
        ...
        <ul id="sidebar_menu" class="sidebar-nav">
            <li class="sidebar-brand"><img class="img-thumbnail" src="assets/img/MCSI2.png" alt="" style="width: 100px; height: 100px; margin-top:10px;border-radius: 20px 20px 20px 20px;"></li>
        </ul>
      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
          <div class="jumbotron" style="margin: 20px 20px 20px 20px; padding: 20px 20px 20px 20px">
              ...
              Tugas UTS Web Pembayaran Zakat 
              </h2>
              ...
              <p>
                Kelompok 12 <br>
                  <ul>
                    <li>Farhan Fauzi Furu</li>
                    <li>Gunawan</li>
                    <li>M.Fidho Hafizh</li>
                    <li>M.Restu Rengga</li>
                    <li>Zaenul Arimba</li>
                  </ul>
              </p>
          </div>
